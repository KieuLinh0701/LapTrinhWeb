...
public class UserDaoImplement extends DBConnection implements IUserDao{
	...
	public UserModel login(String username, String password) {
		UserModel user = this.findOne(username);
	...
	public static void main(String[] args) {
		...
		//test register
		UserModel user = new UserModel(5,"my", "my@gmail.com", "12345", "", "Nguyen Ngoc My");
		if (userDao.register(user)==true) {
			System.out.println("Registration successful!");
		}
		
		//test login
		System.out.println(userDao.login("linh", "12345"));
